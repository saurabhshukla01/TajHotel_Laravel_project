...
<html lang="en">
  <head>
    <title> Taj Hotel @yield('title') </title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/">Taj<span>hotel</span></a>
        ...
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            ...
	            <h1 class="mb-4 bread">@yield('title') Taj Hotel</h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+0 7290 944 755</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">tajhoteldehli@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
